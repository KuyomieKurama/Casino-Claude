...
export default function LiveCasinoPage() {
  return (
    <div className="anim-panel-in space-y-xl pt-6">
      <header className="space-y-2">
        <h1 className="font-display flex items-center gap-2 text-2xl text-primary sm:text-3xl">
          <Radio className="size-6 text-accent" aria-hidden="true" /> Live-Casino
        </h1>
      ...
      <div className="rounded-card border border-border-subtle bg-surface p-lg sm:p-xl">
