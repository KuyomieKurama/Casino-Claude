...
export const metadata: Metadata = { title: "Live-Casino-Demos" };
    ...
    <div className="space-y-6 pt-6">
      <header className="space-y-2">
        ...
        <p className="measure text-sm text-muted">
          Reine UI-Simulation: statischer Dealer-Bereich als Illustration, kein Video, keine realen Personen. Die drei Tische zeigen nur die Informationsarchitektur eines Live-Bereichs.
        </p>
      </header>
      <div className="rounded-card border border-border-subtle bg-surface p-5">
        <div className="signature-top flex aspect-[21/9] items-center justify-center rounded-card border border-border-subtle bg-base">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-muted">Hier stünde im Echtprodukt ein Videostream. Im Prototyp bleibt die Fläche bewusst leer.</p>
          </div>
        </div>
      </div>
      <LiveGrid />
